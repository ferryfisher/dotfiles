;; -*- mode: emacs-lisp; lexical-bind ing: t -*-
...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     ;; Version control
     (git :variables
          git-enable-magit-todos-plugins t)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(kanagawa-wave)
...
before packages are loaded."
  ...
  (unless (display-graphic-p)
    (set-face-background 'default "unspecified" nil))
  )
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(org-agenda-files '("~/org/Academia.org" "/Users/a2z/org/TODO.org"))
   '(package-selected-packages
     '(ace-link aggressive-indent alert all-the-icons auto-compile
                auto-highlight-symbol avy-jump-helm-line browse-at-remote
                centered-cursor-mode clean-aindent-mode closql column-enforce-mode
                compleseus-spacemacs-help cond-let consult consult-yasnippet
                csv-mode define-word devdocs diminish dired-quick-sort
                disable-mouse doom-modeline dotenv-mode drag-stuff dumb-jump eat
                edit-indirect eglot elisp-def elisp-demos elisp-slime-nav emacsql
                embark embark-consult emr esh-help eshell-prompt-extras eshell-z
                ...
                expand-region eyebrowse fancy-battery flycheck flycheck-eglot
                flycheck-elsa flycheck-package flycheck-pos-tip flyspell-correct
                flyspell-correct-popup font-utils forge gh-md ghub git-link
                ...
                ibuffer-projectile imenu-list indent-guide info+ inspector
                json-mode json-navigator json-reformat json-snatcher launchctl
                link-hint llama log4e lorem-ipsum lsp-mode lua-mode macrostep
                magit magit-section marginalia markdown-mode markdown-toc
                multi-line multi-term multi-vterm nameless nerd-icons nix-mode
                nixos-options open-junk-file orderless org-alert org-appear
                ...
                org-projectile org-rich-yank org-sticky-header org-superstar orgit
                orgit-forge osx-clipboard osx-dictionary osx-trash overseer ox-gfm
                package-lint page-break-lines paradox password-generator pcache
                pcre2el persistent-soft popwin pos-tip powerline prettier-js
                quickrun rainbow-delimiters restart-emacs reveal-in-osx-finder
                ron-mode rust-mode rustic shell-pop shrink-path smeargle space-doc
                ...
                treemacs-projectile treepy ucs-utils undo-fu undo-fu-session
                unicode-fonts uuidgen vertico vi-tilde-fringe volatile-highlights
                vterm vundo web-beautify wgrep window-purpose winum with-editor
